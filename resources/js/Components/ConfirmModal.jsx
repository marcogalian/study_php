...
const ConfirmModal = ({children, stateNormal, changeState}) => {
  return (
    <>
                    ...
                    <div className="relative w-full max-w-md max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-6 text-center">
                                ...
                                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Estas seguro, vas a eliminar este post?</h3>
